    ...
    <section className="py-20 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -top-6 -right-6 w-24 h-24 bg-[#dc2828] rounded-full opacity-20"
              />
            </div>
          </motion.div>
          ...
          >
            <div>
              <span className="text-[#dc2828] font-semibold text-lg">Our Story</span>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-[#dc2828] text-black font-semibold rounded-full hover:bg-[#b91c1c] transition-all duration-300 btn-luxury"
            >
