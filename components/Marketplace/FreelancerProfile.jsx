              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 sticky top-6">
                ...
                <div className="space-y-4">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full py-4 bg-[#dc2828] text-black rounded-xl hover:bg-[#b91c1c] transition-colors racing font-bold text-lg"
                  >
                    Hire Sarah
                  </motion.button>
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full py-4 border-2 border-[#dc2828] text-[#dc2828] rounded-xl hover:bg-[#dc2828] hover:text-black transition-all duration-300 racing font-bold"
                  >
                    Send Message
                  </motion.button>
                </div>
              ...
              <div className="flex flex-wrap gap-3">
                {freelancer.skills.map((skill, index) => (
                  <motion.span
                    ...
                    className="px-4 py-2 bg-[#dc2828] text-black rounded-xl racing font-bold"
                  >
                    {skill}
                  </motion.span>
                ))}
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    >
                      <div className="w-10 h-10 bg-[#dc2828] rounded-full flex items-center justify-center">
