...
Please respond immediately to assist this user.`,
  ...
  getFallbackResponse(userMessage) {
    ...
    // urgent fallback
    const urgentKeywords = ["urgent", "emergency", "asap", "immediately", "critical", "help me now"];
    const isUrgent = urgentKeywords.some((keyword) => lowerMessage.includes(keyword));
    ...
    if (lowerMessage.includes("time") || lowerMessage.includes("timeline") || lowerMessage.includes("long")) {
