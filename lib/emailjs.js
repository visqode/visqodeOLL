/**
 * @file emailjs.js
 * @description Email dispatch service using EmailJS SDK.
 * Handles contact form submissions and urgent system notifications.
 */
...
class EmailService {
   ...
   * @param {Object} formData - Form fields (fullName, email, services, budget, description)
   * @returns {Promise<{success: boolean, message?: string, error?: string}>} specific result object
   */
  ...
  /**
   * Sends an immediate alert to the admin email.
   * Used for "urgent" keyword detection in chat.
   * @param {string} subject - Email subject
   * @param {string} message - Email body content
   * @param {string} fromSystem - Sender name (default: "VisQode AI")
   */
